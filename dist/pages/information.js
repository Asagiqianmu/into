...
var Information = function (_wepy$page) {
  ...
  function Information() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Information.__proto__ || Object.getPrototypeOf(Information)).call.apply(_ref, [this].concat(args))), _this), _this.data = {
      list: [],
      btncolor: ''
