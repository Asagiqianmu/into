...
var WaterRecord = function (_wepy$page) {
    _inherits(WaterRecord, _wepy$page);
    ...
    function WaterRecord() {
        ...
        _classCallCheck(this, WaterRecord);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WaterRecord.__proto__ || Object.getPrototypeOf(WaterRecord)).call.apply(_ref, [this].concat(args))), _this), _this.data = {
            list: [],
...
Page(require('./../npm/wepy/lib/wepy.js').default.$createPage(WaterRecord , 'pages/water-record'));
